...
describe('CryptoDetectorEnhanced', () => {
  ...
  it('mergeParameters applies only matching algorithm params', () => {
    ...
    assert.strictEqual(
      (algorithms[0].parameters as Record<string, unknown> | undefined)
        ?.keySize,
      256,
    );
  ...
  it('analyzeStrength classifies penalties into factors and overall levels', () => {
    ...
    const moderate = analyzeStrength(
      ...
      [
        {
          severity: 'high',
          issue: 'unknown implementation flaw',
          recommendation: '',
        },
        {
          severity: 'high',
          issue: 'unknown implementation flaw 2',
          recommendation: '',
        },
        {
          severity: 'high',
          issue: 'unknown implementation flaw 3',
          recommendation: '',
        },
        {
          severity: 'high',
          issue: 'unknown implementation flaw 4',
          recommendation: '',
        },
        {
          severity: 'high',
          issue: 'unknown implementation flaw 5',
          recommendation: '',
        },
      ],
    );
    ...
    const broken = analyzeStrength(
      ...
      [
        ...
        {
          severity: 'critical',
          issue: 'implementation fallback',
          recommendation: '',
        },
        {
          severity: 'critical',
          issue: 'implementation fallback 2',
          recommendation: '',
        },
        {
          severity: 'critical',
          issue: 'implementation fallback 3',
          recommendation: '',
        },
      ],
    );
